...
contract CalculateAmountToBeWithdrawn_Integration_Concrete_Test is StrategyAdapter_Base_Test {
    uint256 repayAmount;
    uint256 gain;

    function test_CalculateAmountToBeWithdrawn_ExceedingDebtZero_RepayAmountZero_GainZero() external view
    {
